...
import { Upload, Save, ArrowLeft, Trash2, Image as ImageIcon, Layers, FileDigit, Type } from 'lucide-react';
...
export default function CreateChapterPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const handleUploadImage = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Hiển thị trạng thái loading ảo nếu cần, hoặc chỉ đơn giản là đợi
