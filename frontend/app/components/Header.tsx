...
import Link from 'next/link'; // ✅ QUAN TRỌNG: Dùng Link thay cho a
      ...
      <nav className="relative container mx-auto flex items-center justify-between p-4">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6">
            {[
              ...
              // ✅ Sửa a -> Link để không bị reload trang
              <Link
                key={item.name}
                href={item.href}
        ...
        <div className="flex items-center gap-4">
          ...
          <SignedOut>
            ...
            <Link
              href="/sign-in"
              className="rounded-full bg-blue-600 hover:bg-blue-700 px-5 py-2 text-white font-medium transition whitespace-nowrap"
            >
              Đăng nhập
            </Link>
          </SignedOut>
